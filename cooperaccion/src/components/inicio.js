...
<motion.p animate={clicked ? inactive : active} className={clicked ? 'inactive' : ''}> Es viernes por la tarde, los chicos y las chicas de 1°, 2°, 3° y 4° año son los únicos cursos que
